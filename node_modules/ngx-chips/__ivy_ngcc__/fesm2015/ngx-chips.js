...
function TagComponent_div_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r105.editing);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction2(3, _c1, ctx_r105.model, ctx_r105.index))("ngTemplateOutlet", ctx_r105.template);
} }
function TagComponent_div_2_delete_icon_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("click", function TagComponent_div_2_delete_icon_3_Template_delete_icon_click_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r111); const ctx_r110 = ɵngcc0.ɵɵnextContext(2); return ctx_r110.remove($event); });
    ɵngcc0.ɵɵelementEnd();
} }
function TagComponent_div_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("keydown.enter", function TagComponent_div_2_Template_div_keydown_enter_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r113); const ctx_r112 = ɵngcc0.ɵɵnextContext(); return ctx_r112.disableEditMode($event); })("keydown.escape", function TagComponent_div_2_Template_div_keydown_escape_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r113); const ctx_r114 = ɵngcc0.ɵɵnextContext(); return ctx_r114.disableEditMode($event); })("click", function TagComponent_div_2_Template_div_click_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r113); const ctx_r115 = ɵngcc0.ɵɵnextContext(); return ctx_r115.editing ? $event.stopPropagation() : undefined; })("blur", function TagComponent_div_2_Template_div_blur_1_listener($event) { ɵngcc0.ɵɵrestoreView(_r113); const ctx_r116 = ɵngcc0.ɵɵnextContext(); return ctx_r116.onBlurred($event); });
    ɵngcc0.ɵɵtext(2);
    ɵngcc0.ɵɵelementEnd();
    ...
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵattribute("contenteditable", ctx_r106.editing)("title", ctx_r106.getDisplayValue(ctx_r106.model));
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵtextInterpolate1(" ", ctx_r106.getDisplayValue(ctx_r106.model), " ");
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngIf", ctx_r106.isDeleteIconVisible());
} }
function TagComponent_tag_ripple_3_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("state", ctx_r107.rippleState);
...
function TagInputDropdown_ng2_menu_item_2_span_1_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r118 = ɵngcc0.ɵɵnextContext().$implicit;
    const ctx_r121 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("innerHTML", ɵngcc0.ɵɵpipeBind2(1, 1, item_r118[ctx_r121.displayBy], ctx_r121.tagInput.inputForm.value.value), ɵngcc0.ɵɵsanitizeHtml);
} }
...
function TagInputDropdown_ng2_menu_item_2_2_Template(rf, ctx) { if (rf & 1) {
    ...
    const item_r118 = ctx_r125.$implicit;
    const index_r119 = ctx_r125.index;
    const last_r120 = ctx_r125.last;
    const ctx_r122 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵproperty("ngTemplateOutlet", ctx_r122.templates.first)("ngTemplateOutletContext", ɵngcc0.ɵɵpureFunction3(2, _c2, item_r118, index_r119, last_r120));
} }
function TagInputDropdown_ng2_menu_item_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("value", item_r118)("ngSwitch", !!ctx_r117.templates.length);
    ɵngcc0.ɵɵadvance(1);
...
function TagInputComponent_tag_2_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵlistener("onSelect", function TagInputComponent_tag_2_Template_tag_onSelect_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r132); const item_r129 = ctx.$implicit; const ctx_r131 = ɵngcc0.ɵɵnextContext(); return ctx_r131.selectItem(item_r129); })("onRemove", function TagInputComponent_tag_2_Template_tag_onRemove_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r132); const item_r129 = ctx.$implicit; const i_r130 = ctx.index; const ctx_r133 = ɵngcc0.ɵɵnextContext(); return ctx_r133.onRemoveRequested(item_r129, i_r130); })("onKeyDown", function TagInputComponent_tag_2_Template_tag_onKeyDown_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r132); const ctx_r134 = ɵngcc0.ɵɵnextContext(); return ctx_r134.handleKeydown($event); })("onTagEdited", function TagInputComponent_tag_2_Template_tag_onTagEdited_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r132); const ctx_r135 = ɵngcc0.ɵɵnextContext(); return ctx_r135.updateEditedTag($event); })("onBlur", function TagInputComponent_tag_2_Template_tag_onBlur_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r132); const i_r130 = ctx.index; const ctx_r136 = ɵngcc0.ɵɵnextContext(); return ctx_r136.onTagBlurred($event, i_r130); })("dragstart", function TagInputComponent_tag_2_Template_tag_dragstart_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r132); const item_r129 = ctx.$implicit; const i_r130 = ctx.index; const ctx_r137 = ɵngcc0.ɵɵnextContext(); return ctx_r137.dragZone ? ctx_r137.onDragStarted($event, item_r129, i_r130) : undefined; })("drop", function TagInputComponent_tag_2_Template_tag_drop_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r132); const i_r130 = ctx.index; const ctx_r138 = ɵngcc0.ɵɵnextContext(); return ctx_r138.dragZone ? ctx_r138.onTagDropped($event, i_r130) : undefined; })("dragenter", function TagInputComponent_tag_2_Template_tag_dragenter_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r132); const ctx_r139 = ɵngcc0.ɵɵnextContext(); return ctx_r139.dragZone ? ctx_r139.onDragOver($event) : undefined; })("dragover", function TagInputComponent_tag_2_Template_tag_dragover_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r132); const i_r130 = ctx.index; const ctx_r140 = ɵngcc0.ɵɵnextContext(); return ctx_r140.dragZone ? ctx_r140.onDragOver($event, i_r130) : undefined; })("dragleave", function TagInputComponent_tag_2_Template_tag_dragleave_0_listener($event) { ɵngcc0.ɵɵrestoreView(_r132); const ctx_r141 = ɵngcc0.ɵɵnextContext(); return ctx_r141.dragZone ? ctx_r141.dragProvider.onDragEnd() : undefined; });
    ɵngcc0.ɵɵelementEnd();
} if (rf & 2) {
    const item_r129 = ctx.$implicit;
    const i_r130 = ctx.index;
    const ctx_r126 = ɵngcc0.ɵɵnextContext();
    ɵngcc0.ɵɵpropertyInterpolate("draggable", ctx_r126.editable);
    ɵngcc0.ɵɵproperty("canAddTag", ctx_r126.isTagValid)("disabled", ctx_r126.disable)("@animation", ctx_r126.animationMetadata)("hasRipple", ctx_r126.ripple)("index", i_r130)("removable", ctx_r126.removable)("editable", ctx_r126.editable)("displayBy", ctx_r126.displayBy)("identifyBy", ctx_r126.identifyBy)("template", !!ctx_r126.hasCustomTemplate() ? ctx_r126.templates.first : undefined)("draggable", ctx_r126.dragZone)("model", item_r129);
...
function TagInputComponent_div_6_p_1_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵadvance(2);
    ɵngcc0.ɵɵtextInterpolate(error_r143);
} }
function TagInputComponent_div_6_Template(rf, ctx) { if (rf & 1) {
    ...
    ɵngcc0.ɵɵproperty("ngClass", ctx_r128.theme);
    ɵngcc0.ɵɵadvance(1);
    ɵngcc0.ɵɵproperty("ngForOf", ctx_r128.errors);
} }
const _c3 = ["*"];
